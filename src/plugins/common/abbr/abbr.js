...
;
;
define = window.Aloha.define;document.write('<script data-gg-define="abbr/nls/i18n" src="' + ALOHA_BASE_URL + 'plugins/common/abbr/nls/i18n.js"></script>');
;
define = window.Aloha.define;document.write('<script data-gg-define="abbr/abbr-plugin" src="' + ALOHA_BASE_URL + 'plugins/common/abbr/lib/abbr-plugin.js"></script>');// Because almond.js clobbers these global variables, we preserve them.
