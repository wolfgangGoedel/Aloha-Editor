( function ( window, undefined ) {
	...
	Aloha.settings = {
		...
		requireConfig: {
			paths: {
				'ui/ui-plugin': '/js/wikidocs-app/aloha/ui-plugin',
				'ui/component': '/js/wikidocs-app/aloha/component',
				'ui/button'   : '/js/wikidocs-app/aloha/button',
				'ui/toggleButton'   : '/js/wikidocs-app/aloha/toggleButton',
				'ui/port-helper-attribute-field': '/js/wikidocs-app/aloha/port-helper-attribute-field',
				'ui/port-helper-multi-split': '/js/wikidocs-app/aloha/port-helper-multi-split',
				'aloha-original-ui-component': '/Aloha-Editor/src/plugins/common/ui/lib/component',
				'aloha-original-ui-port-helper-attribute-field': '/Aloha-Editor/src/plugins/common/ui/lib/port-helper-attribute-field',
				'aloha-original-ui-port-helper-multi-split': '/Aloha-Editor/src/plugins/common/ui/lib/port-helper-multi-split',
				'aloha-original-ui-button': '/Aloha-Editor/src/plugins/common/ui/lib/button',
				'aloha-original-ui-toggleButton': '/Aloha-Editor/src/plugins/common/ui/lib/toggleButton'
			}
		},
		...
		plugins: {
			format: {
				...
				config: [  'b', 'i', 'p', 'u', 's', 'sub', 'sup', 'del', 'title', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'pre', 'removeFormat' ],
				editables: {
