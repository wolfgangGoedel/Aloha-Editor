...
;
;
define = window.Aloha.define;document.write('<script data-gg-define="dom-to-xhtml/dom-to-xhtml" src="' + ALOHA_BASE_URL + 'plugins/common/dom-to-xhtml/lib/dom-to-xhtml.js"></script>');
define = window.Aloha.define;document.write('<script data-gg-define="dom-to-xhtml/dom-to-xhtml-plugin" src="' + ALOHA_BASE_URL + 'plugins/common/dom-to-xhtml/lib/dom-to-xhtml-plugin.js"></script>');// Because almond.js clobbers these global variables, we preserve them.
