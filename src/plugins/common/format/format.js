...
;
define = window.Aloha.define;document.write('<script data-gg-define="format/format-plugin" src="' + ALOHA_BASE_URL + 'plugins/common/format/lib/format-plugin.js"></script>');// Because almond.js clobbers these global variables, we preserve them.
