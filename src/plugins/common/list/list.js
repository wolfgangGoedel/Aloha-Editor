...
;
define = window.Aloha.define;document.write('<script data-gg-define="list/list-plugin" src="' + ALOHA_BASE_URL + 'plugins/common/list/lib/list-plugin.js"></script>');// Because almond.js clobbers these global variables, we preserve them.
