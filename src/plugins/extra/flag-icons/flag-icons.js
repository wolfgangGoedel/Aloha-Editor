...
define = window.Aloha.define;document.write('<script data-gg-define="flag-icons/flag-icons-plugin" src="' + ALOHA_BASE_URL + 'plugins/extra/flag-icons/lib/flag-icons-plugin.js"></script>');// Because almond.js clobbers these global variables, we preserve them.
