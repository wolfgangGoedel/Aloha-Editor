...
;
;
define = window.Aloha.define;document.write('<script data-gg-define="imagebrowser/nls/i18n" src="' + ALOHA_BASE_URL + 'plugins/extra/imagebrowser/nls/i18n.js"></script>');
define = window.Aloha.define;document.write('<script data-gg-define="imagebrowser/imagebrowser-plugin" src="' + ALOHA_BASE_URL + 'plugins/extra/imagebrowser/lib/imagebrowser-plugin.js"></script>');// Because almond.js clobbers these global variables, we preserve them.
