...
;
;
define = window.Aloha.define;document.write('<script data-gg-define="toc/nls/i18n" src="' + ALOHA_BASE_URL + 'plugins/extra/toc/nls/i18n.js"></script>');
;
define = window.Aloha.define;document.write('<script data-gg-define="toc/toc-plugin" src="' + ALOHA_BASE_URL + 'plugins/extra/toc/lib/toc-plugin.js"></script>');// Because almond.js clobbers these global variables, we preserve them.
