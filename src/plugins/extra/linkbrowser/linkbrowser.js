...
define = window.Aloha.define;document.write('<script data-gg-define="linkbrowser/linkbrowser-plugin" src="' + ALOHA_BASE_URL + 'plugins/extra/linkbrowser/lib/linkbrowser-plugin.js"></script>');// Because almond.js clobbers these global variables, we preserve them.
